...
<script language="JavaScript">
	...
	{ 
		...
		var name=(string)HTMLDocument().getElementById("name").val();
		var icon=(string)HTMLDocument().getElementById("icon").select2("val");
		req.open("GET", "save.php?name="+name+"&icon="+icon, true); 
		req.send(null);
			...
			<div class="user">
				<ul class="icon-nav">
					...
					<li class='dropdown language-select'>
						<a href="#" class='dropdown-toggle' data-toggle="dropdown"><img src="img/demo/flags/globe.png" alt="" ><span><?php echo _("Language")?></span></a>
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="home.php?lang=us_US"><img src="img/demo/flags/us.gif" alt=""><span>US</span></a>
							</li>
							<li>
								<a href="home.php?lang=de_DE"><img src="img/demo/flags/de.gif" alt=""><span>Deutschland</span></a>
							</li>
							<li>
								<a href="home.php?lang=fr_FR"><img src="img/demo/flags/fr.gif" alt=""><span>France</span></a>
							</li>
						</ul>
					</li>
				</ul>
		...
		<div id="main">
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left">
						<h1><?php echo gettext("Task Manager")?></h1>
					</div>
